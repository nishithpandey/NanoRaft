...
import static io.nanoraft.test.util.RaftTestUtils.getVotedEndpoint;
import static io.nanoraft.test.util.RaftTestUtils.majority;
import static io.nanoraft.test.util.RaftTestUtils.minority;
import static io.nanoraft.test.util.AssertionUtils.sleepMillis;
