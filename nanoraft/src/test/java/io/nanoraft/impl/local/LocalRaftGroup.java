...
import io.nanoraft.test.util.AssertionUtils;
...
public final class LocalRaftGroup {
    ...
    private void createNodes(int groupSize, int votingMemberCount, RaftConfig config,
        ...
        for (int i = 0; i < groupSize; i++) {
            ...
            RaftNodeContext context = new RaftNodeContext((DefaultRaftNodeExecutor) node.getExecutor(), transport,
                    stateMachine, node);
     ...
     * @param includeLeader
     *            denotes whether if the leader Raft node can be returned or not
     *
    ...
    public static final class LocalRaftGroupBuilder {
         ...
         *            the factory object for creating Raft state stores
         *
         * @return the builder object for fluent calls
         */
