...
import static io.nanoraft.impl.local.LocalRaftGroup.IN_MEMORY_RAFT_STATE_STORE_FACTORY;
...
import static io.nanoraft.test.util.RaftTestUtils.getLastApplied;
import static io.nanoraft.test.util.RaftTestUtils.getLastLogOrSnapshotEntry;
import static io.nanoraft.test.util.RaftTestUtils.getRaftStore;
import static io.nanoraft.test.util.RaftTestUtils.getRestoredState;
...
import static io.nanoraft.test.util.RaftTestUtils.getTerm;
...
import io.nanoraft.impl.local.InMemoryRaftStore;
