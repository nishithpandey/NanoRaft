...
public class RaftException extends RuntimeException {
    ...
    /**
     * Returns the leader endpoint of the related Raft group, if available and known
     * by the Raft node by the time this exception is thrown.
     *
     * @return the leader endpoint of the related Raft group, if available and known
     *         by the Raft node by the time this exception is thrown
     */
