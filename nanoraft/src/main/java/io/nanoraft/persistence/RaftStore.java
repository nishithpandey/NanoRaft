...
public interface RaftStore {
     ...
     * <p>
     * In another rare failure scenario, NanoRaft can delete a range of the latest
     ...
     * <p>
     * NanoRaft takes snapshots at a predetermined interval, controlled by
    ...
    /**
     * NanoRaft calls this method after it successfully persists and flushes a
     ...
     *
     * NanoRaft calls this method when it detects that it needs to start installing
