...
package io.nanoraft.tutorial.atomicregister;
...
/**
 * This is the base class for our atomic register implementation. In this class,
 * we only define a marker interface for the operations we will commit on the
 * atomic register state machine, and the "new term operation" which will be
 ...
 * <p>
 * https://github.com/NanoRaft/NanoRaft/blob/master/nanoraft-tutorial/src/main/java/io/nanoraft/tutorial/atomicregister/AtomicRegister.java
 */
