...
/*
   ...
   https://github.com/NanoRaft/NanoRaft/blob/master/nanoraft-tutorial/src/test/java/io/nanoraft/tutorial/OperationCommitTest.java
...
public class OperationCommitTest extends BaseLocalTest {
    ...
    public void testCommitOperation() {
        ...
        System.out.println(
                "1st operation commit index: " + result1.getCommitIndex() + ", result: " + result1.getResult());
        ...
        System.out.println(
                "2nd operation commit index: " + result2.getCommitIndex() + ", result: " + result2.getResult());

        String value3 = "value3";
        Ordered<Boolean> result3 = leader.<Boolean>replicate(OperableAtomicRegister.newCasOperation(value2, value3))
                .join();
        ...
        System.out.println(
                "3rd operation commit index: " + result2.getCommitIndex() + ", result: " + result3.getResult());

        String value4 = "value4";
        Ordered<Boolean> result4 = leader.<Boolean>replicate(OperableAtomicRegister.newCasOperation(value2, value4))
                .join();
        ...
        System.out.println(
                "4th operation commit index: " + result4.getCommitIndex() + ", result: " + result4.getResult());
        ...
        System.out.println(
                "5th operation commit index: " + result5.getCommitIndex() + ", result: " + result5.getResult());
    }
