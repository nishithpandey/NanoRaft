...
# Introducing NanoRaft

_September 3, 2021 | Ensar Basri Kahveci_

___Disclaimer: NanoRaft is a project I develop in my free time. It is not
...
I am pleased to announce the first public release of NanoRaft! NanoRaft is an
open-source implementation of the <a href="https://raft.github.io/"
target="_blank">Raft consensus algorithm</a> in Java. You can use NanoRaft to
build highly available and strongly consistent data, metadata and coordination
services. The source code is available at <a
href="https://github.com/NanoRaft/NanoRaft">Github</a> with the Apache 2
License.
...
href="https://nanoraft.io/#features" target="_blank">a rich set of
...
NanoRaft works on top of a minimalistic and modular design. It is a single
...
You can use NanoRaft to build highly available and strongly consistent data,
...
The following figure depicts NanoRaft's main abstractions. `RaftNode` runs the
...
Run the following command on your terminal for a sneak peek at NanoRaft. It
starts a 3-node local Raft group (a Raft cluster in NanoRaft terms), elects a
...
to build an atomic register on top of NanoRaft and for full details, check out
NanoRaft's [APIs and main abstractions](/docs/apis-and-main-abstractions).

## Ode to open source

I couldn't have brought NanoRaft into the daylight without the power of open
source. NanoRaft originates from [the Raft
...
<a href="https://github.com/NanoRaft/NanoRaft/commits/master"
target="_blank">commit history</a>.

NanoRaft proudly carries on Hazelcast's open-source heritage and is released 
with the Apache 2 License.

## What is next

I wrote down <a href="https://nanoraft.io/docs/roadmap/" target="_blank">a list
of future work</a> on NanoRaft. I am planning to work on them in my free time.
The list is tentative and there is nothing urgent at the moment.

NanoRaft is a new open source project. Any kind of contribution and feedback is
welcome! The development happens on <a
href="https://github.com/NanoRaft/NanoRaft" target="_blank">Github</a>. Last,
you can follow <a href="https://twitter.com/nanoraft"
