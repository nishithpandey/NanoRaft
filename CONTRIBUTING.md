# Contributing to NanoRaft

By contributing code to the NanoRaft project in any form, including sending 
...
can find in the NanoRaft repository. 
...
You can chime in to [Discussions](https://github.com/NanoRaft/NanoRaft/discussions) 
for your questions, ideas or feature requests.

## How to Provide a Code Change

No direct commits are allowed to the NanoRaft repository. If you want to 
provide a code change:

1. Fork NanoRaft on Github,
2. Create a branch for your code change, 
3. Push to your branch on your fork,
4. Create a pull request to the NanoRaft repository.

NanoRaft contains `checkstyle` and `spotbugs` tools for static code analysis.
